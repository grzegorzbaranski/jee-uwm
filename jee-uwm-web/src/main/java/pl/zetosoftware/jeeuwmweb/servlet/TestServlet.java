...
public class TestServlet extends  HttpServlet{
    ...
    private static String PAGE_HEADER = "<html><head><title>test-servlet</title></head><body>";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        writer.println("<h1>" + "TEST SERVLET UWM 2017" + "</h1>");
        writer.println("<p>"+ "Cookie : "+ getCookie(NAZWA, req)+"</p>");
        writer.println("<p>"+ "Parametr p1: "+req.getParameter("p1")+"</p>");
